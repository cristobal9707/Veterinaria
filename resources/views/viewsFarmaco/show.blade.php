            ...
            <v-container fluid grid-list-lg>
                <v-layout align-space-around justify-center column class="form-contenedor">
                    <v-card style="padding: 10px;">
                        <h1>Farmaco: N°{{ $Farmacos->id }}</h1>
                        <v-btn color="info" href="{{ url('/farmacos') }}">Volver</v-btn>
                        <v-divider></v-divider>
                        <h3>Información del Farmaco</h3>
                        <h5>Nombre: {{ $Farmacos->nombre }}</h5>
                        <h5>Categoria: {{ $Farmacos->categoria }}</h5>
                        <h5>Comprimido: {{ $Farmacos->comprimido }}</h5>
                        <h5>Contenido neto: {{ $Farmacos->contenido_neto }}</h5>
                        <h5>Precio: {{ $Farmacos->precio }}</h5>
                        <v-divider></v-divider>
                        <h3>Fechas</h3>
                        <h5>Fecha agregado: {{ $Farmacos->created_at }}</h5>
                        <h5>Fecha editado: {{ $Farmacos->updated_at }}</h5>
