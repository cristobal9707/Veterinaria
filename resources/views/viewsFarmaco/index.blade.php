            ...
            <v-container fluid grid-list-lg>
                <v-layout align-space-around justify-center column class="form-contenedor">
                    <v-card style="padding: 10px;">
                        <h1>Farmacos</h1>
                        <v-btn color="success" href="/farmacos/create">Agregar</v-btn>
                        <div class="content">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->comprimido }} </td>
                                    <td>{{ $item->contenido_neto }} </td>
                                    <td>$ {{ $item->precio }}</td>
                                    <td>
                                        <form action="/farmacos/{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <v-btn color="success" href="/farmacos/{{ $item->id }}">Informacion</v-btn>
                                            <v-btn color="info" href="/farmacos/{{ $item->id }}/edit">Editar</v-btn>
