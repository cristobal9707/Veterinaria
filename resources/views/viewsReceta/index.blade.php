            ...
            <v-container fluid grid-list-lg>
                <v-layout align-space-around justify-center column class="form-contenedor">
                    <v-card style="padding: 10px;">
                        <h1>Recetas</h1>
                        <v-btn color="success" href="/recetas/create">Agregar</v-btn>
                        <div class="content">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->farmacos->nombre }}</td>
                                    <td>{{ $item->cantidad }}</td>
                                    <td>{{ $item->farmacos->precio }}</td>
                                    <td> 0 </td>
                                    <td>
                                        <form action="/recetas/{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <v-btn color="success" href="/recetas/{{ $item->id }}">Informacion</v-btn>
                                            <v-btn color="info" href="/recetas/{{ $item->id }}/edit">Editar</v-btn>
