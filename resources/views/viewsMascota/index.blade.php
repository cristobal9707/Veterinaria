            ...
            <v-container fluid grid-list-lg>
                <v-layout align-space-around justify-center column class="form-contenedor">
                    <v-card style="padding: 10px;">
                        <h1>Mascotas</h1>
                        <v-btn color="success" href="/mascotas/create">Agregar</v-btn>
                        <div class="content">
                            <table class="table">
                                <thead>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->genero }}</td>
                                    <td>
                                        <form action="/mascotas/{{ $item->id }}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <v-btn color="success" href="/mascotas/{{ $item->id }}">Informacion</v-btn>
                                            <v-btn color="info" href="/mascotas/{{ $item->id }}/edit">Editar</v-btn>
